const {users, staff_logs, roles, users_roles, permissions, reset_passwords} = require('../models');
...
const addUser = async (req, res) => {
  ...
  try {
    ...
    await sendEmail(
      email, 
      `OGCEMPC Portal ${role_name} Account Creation`,
       `
       Welcome! You have been granted an account for the OGCEMPC Portal, your details are:
  ...
  <body>
    <div class="container">
        <div class="header">
            OCGEMPC ${role_name} ACCOUNT CREATION
        </div>
  
        <div class="content">
            <h1 class="title"> Welcome! You have been granted an account for the OCGEMPC Portal, your details are:</h1>
